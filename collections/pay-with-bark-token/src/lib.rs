...
const BARK_MINT_ADDRESS: Pubkey = pubkey!("2NTvEssJ2i998V2cMGT4Fy3JhyFnAzHFonDo9dbAkVrg");

#[collection]
pub mod pay_with_bark_token { 
    use super::*;
    ...
    fn pay(ctx: Context<PayAction>) -> Result<ActionTransaction> {
        ...
        let mut instructions = vec![create_bark_ata_instruction];
    ...
    fn get_pay(ctx: Context<PayAction>) -> Result<ActionMetadata> {
        ...
        Ok(ActionMetadata {
            title: "Pay with BARK using any SPL token".to_string(),
