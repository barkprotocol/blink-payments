...
const SOL_MINT_ADDRESS: Pubkey = pubkey!("So11111111111111111111111111111111111111112");
...
pub mod pay_with_sol { 
    ...
    fn pay(ctx: Context<PayAction>) -> Result<ActionTransaction> {
        ...
        let mut instructions = vec![create_sol_ata_instruction];
